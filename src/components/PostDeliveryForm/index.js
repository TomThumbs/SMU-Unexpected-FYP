...
class PostDeliveryFormBase extends Component {
  ...
  <div class="body">
    <Container component="main" maxWidth="xs">
      <Typography variant="h5" component="h2">Declaration for Order #{this.props.location.orderid} Successful.</Typography>
      <Typography variant="h6" component="h1">Driver: {this.props.location.driver}</Typography>
      <br></br>
      <Grid container spacing={3}>
        <Grid item xs spacing={3}>
         <img class="image" src={this.props.location.url} ></img>
        </Grid>
      </Grid>
        <br></br>
