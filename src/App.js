...
import {
	NewIngredient,
	NewBasicIngredient,
	NewComplexIngredient,
} from "./components/NewIngredient";
...
import {
	OrderPreparation,
	OrderPreparationEdit,
	OrderPreparationSop,
	OrderPreparationPostSop,
} from "./components/OrderPreparation";
...
import HeaterManagement from "./components/HeaterManagement";
	...
	<div className="App">
		<header className="App-header">
			<Router>
				...
				<Route path={ROUTES.HEATER_MANAGEMENT} component={HeaterManagement} />
				<Route
					path={ROUTES.SMART_HEATING_TEST}
					component={SmartHeaterDisplay}
				/>
				...
				<Route
					path={ROUTES.NEW_INGREDIENT_BASIC}
					component={NewBasicIngredient}
				/>
				<Route
					path={ROUTES.NEW_INGREDIENT_COMPLEX}
					component={NewComplexIngredient}
				/>
				...
				{/* ---------- DELETE INGREDIENT ---------- */}
				<Route
					path={ROUTES.DELETE_INGREDIENT}
					component={DeleteIngredientForm}
				/>
				...
				<Route
					path={ROUTES.ORDER_PREPARATION_EDIT}
					component={OrderPreparationEdit}
				/>
				<Route
					path={ROUTES.ORDER_PREPARATION_SOP}
					component={OrderPreparationSop}
				/>
				<Route
					path={ROUTES.ORDER_PREPARATION_POST_SOP}
					component={OrderPreparationPostSop}
				/>
				...
				<Route
					path={ROUTES.DISH_TO_INGREDIENT_FORM}
					component={DishToIngredientForm}
				/>
